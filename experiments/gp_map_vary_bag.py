...
folder_path = 'path/to/save/to/gpmap_results'

for bag_size_c in bag_size:
    file_path = os.path.join(folder_path, 'bag_{}_mean_{}_std_{}_gen_{}_net_gpmap_link_{}_structure_{}_reg_{}_reg_out_{}_lr_{}_data_seed_{}_init_{}'.format(
